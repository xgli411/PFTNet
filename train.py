...
#from DeepRFT_MIMO_FFTER import DeepRFT as myNet
from PFTNet import DeepRFT as myNet
#from DeepRFT_MIMO_FFTER_plus import DeepRFT_plus as myNet
import losses
...
parser.add_argument('--train_dir', default='./Datasets/train_c/', type=str, help='Directory of train images')
parser.add_argument('--val_dir', default='./Datasets/val_c', type=str, help='Directory of validation images')
parser.add_argument('--model_save_dir', default='./checkpoints/', type=str, help='Path to save weights')
#parser.add_argument('--pretrain_weights', default='./checkpoints/DeepRFT_MIMO_FFTER_SMALL_prompt/Deblurring/models/DeepRFT_gopro/model_epoch.pth', type=str, help='Path to pretrain-weights')
parser.add_argument('--pretrain_weights', default='./checkpoints/model_epoch.pth', type=str, help='Path to pretrain-weights')
...
if RESUME:
    ...
    path_chk_rest = utils.get_last_path(model_dir, '_epoch_2840.pth')
...
for epoch in range(start_epoch, num_epochs + 1):
    ...
    for i, data in enumerate(tqdm(train_loader), 0):
        ...
        loss = loss_char + 0.1 * loss_fft + 0.05 * loss_edge
        loss.backward()
        optimizer.step()
