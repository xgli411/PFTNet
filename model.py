...
class PromptGenBlock(nn.Module):
    def __init__(self,prompt_dim=128,prompt_len=5,prompt_size = 96,lin_dim = 192):
        ...
        #self.conv3x3 = DOConv2d(prompt_dim,prompt_dim,kernel_size=3,stride=1,padding=1,bias=False)
        #self.conv3x3 = self.conv3x3 = nn.Conv2d(prompt_dim,prompt_dim,kernel_size=3,stride=1,padding=1,bias=False)
        #self.conv3x3 = ScConv(prompt_dim)
